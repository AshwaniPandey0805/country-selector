...
@section('content')
    <div class="container">
        ...
        <!-- Form Section -->
        <div class="mb-5">
            <form action="#" id="state_update">
                @csrf
                <div class="mb-3">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" name="name" value="{{$state->state_name}}"  id="name" class="form-control" placeholder="Enter Country name">
                    <p></p>
                </div>
                <div class="mb-3">
...
@section('custom-js')
    <script>
        $("#state_update").submit(function(event){
